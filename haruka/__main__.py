...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        try:
            update.effective_message.reply_text("Hey there! I'm alive. PM Me If You Have Any Questions!")
        except:
            print("Nut")
...
Click Help button to find out more about how to use me to my full potential.\n\n"
    ...
    text += "Join [Haruka Aya Group](https://t.me/Sabrina_RobotChat) if you need any support or help\n\n\
Follow [Haruka Aya](https://t.me/Hackers_Squad) if you want to keep up with the news, updates and bot downtime!\n\n\
Made with love by @RealAkito\n\nWant to add me to your group? [Click here!](t.me/Haruka_Aya_Bot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="Founder", url="https://t.me/Unknown_Hacker_X")]]
